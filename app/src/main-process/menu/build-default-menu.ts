    ...
    submenu: [
      {
        ...
        label: __DARWIN__ ? 'Undo' : '&Undo',
      },

      {
        role: 'redo',

        label: __DARWIN__ ? 'Redo' : '&Redo',
      },
...

      {
        ...
        label: __DARWIN__ ? 'Cut' : 'Cu&t',
      },

      {
        role: 'copy',

        label: __DARWIN__ ? 'Copy' : '&Copy',
      },

      {
        role: 'paste',

        label: __DARWIN__ ? 'Paste' : '&Paste',
      },
...
const ZoomOutFactors = ZoomInFactors.slice()
.reverse()
