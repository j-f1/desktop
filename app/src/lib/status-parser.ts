...
const changedEntryRe = /^1 ([MADRCU?!.]{2}) (N\.\.\.|S[C.][M.][U.]) (\d+) (\d+) (\d+) ([a-f\d]+) ([a-f\d]+) (.*?)$/
...
const renamedOrCopiedEntryRe = /^2 ([MADRCU?!.]{2}) (N\.\.\.|S[C.][M.][U.]) (\d+) (\d+) (\d+) ([a-f\d]+) ([a-f\d]+) ([RC]\d+) (.*?)$/
...
const unmergedEntryRe = /^u ([DAU]{2}) (N\.\.\.|S[C.][M.][U.]) (\d+) (\d+) (\d+) (\d+) ([a-f\d]+) ([a-f\d]+) ([a-f\d]+) (.*?)$/
